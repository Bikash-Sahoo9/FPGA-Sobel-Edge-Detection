...
HD_PWD='C:/Users/bikas/sobel_fpga/sobel_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sobel_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sobel_top.tcl
