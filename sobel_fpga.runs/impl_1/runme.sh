...
HD_PWD='C:/Users/bikas/sobel_fpga/sobel_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sobel_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sobel_top.tcl -notrace
